...
\chapter{Literature review}
	...
	\section{Emotion processing}
		...
		%1. emotion mood and affect
		%2. categorical and dimensional approaches
		%3. appraisal theories and feeling of power and control influences the emotional valence
		%4. conscious and automatic appraisal processess(Smith and Kirby 2009)
		%5. manipulating appraisal changes emotion there is causation effect (find study from 639-642)
		%6. However, according to McEachrane\cite{} there is no clear distinction between emotion and cognition.
		%7. Emotional state influences different aspects of cognition, like attention, perception, working memory, decision making, learning according ti blanchette richards 2010\cite
		%What an individual remembers from an event is influenced by what she attended at the moment of the event(Erik and st James)
		%8. Positive affect is suggested to broadening the attention, in contrast to negative affect that it narrows the attention.
		%9. Harmon-Jones (2011) claims we should include motivational intensity
		10. mood congruity
		11. Dual process model - fast automatic and affective system and slower effortful and more cognitive system
		12. Emotional measures - SAM
	...
	Next, relevant studies that try to infer mental workload and emotional valence using fNIRS will be reviewed in the subsections below.
		\subsection{PFC and emotion processing and mental workload}
		some text..
