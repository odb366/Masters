...
\chapter{User study}
	...
	\section{Results}
		\subsection{Mental Workload}
			...
			\begin{figure}
				\includegraphics[width=0.7\linewidth]{../Desktop/Results/graphs/mean-hbo-index123}
			...
			No statistical significance was found when comparing the means of Hbr $F(2,20)=2.044, p<.156,$ partial $\eta^{2}=.170$ and Hbt $F(2,20)=0.685, p<.516,$ partial $\eta^{2}=.064$.
			\subsubsection{NASA-TLX}
