...
\chapter{Literature review}
	...
	A more recent brain imaging technique is the functional near infrared spectroscopy (fNIRS) which unlike EEG is an optical-imaging modality. fNIRS can detect cerebral hemodynamics by calculating the oxygenated haemoglobin(Hbo) and deoxygenated haemoglobin(Hbr). It uses infrared light, usually 650-1000nm wavelenght, which is emitted to the participants skull using emitter-detector pairs consisting of infrared LED emitter, and infrared sensors. They usually operate with two or more wavelengths. Furthermore, because Hbo and Hbr have different light absorption coefficients the concentration of Hbo and Hbr can be calculated using modified Beer-Lamberts law\cite{delpy1988estimation}. fNIRS has good temporal
