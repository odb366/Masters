	...
	\section{Results}
		...
		\subsection{Emotional Valence}
			\subsubsection{fNIRS differences}
				...
				There was no correlation between Hbo valence differences and SAM emotional valence subjective scale for the three videos   $r(9)=-0.490, p=0.126$; $r(9)=0.095, p=0.781$; $r(9)=0.496, p=0.121$. 
