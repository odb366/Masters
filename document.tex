...
I would like to sincerely thank \textbf{Anry Levy} for giving me the opportunity to study my favourite subject HCI in a word class university. I'm really grateful and must point that such good-natured people are rarely seen. Thanks to the Fadata personnel that helped me in one or other way in my journey in England.

In addition, special thanks goes to \textbf{Max L. Wilson} which supervised the master thesis and provided me with great feedback and guidance. Thanks for you positive attitude, which motivated me to work more. I cannot surpass, also \textbf{Horia Maior} for the tremendous help in and out of the university. Thanks for everything man, you was a real friend to me. 

Also, I would like to thank my whole family - \textbf{Emil}, \textbf{Teodora} for the outstanding support, especially \textbf{Mario} and \textbf{Dayana}. Without them all of this would not be possible. Thanks to my grandparents, you are just wonderful and always ready to help! Thanks to my friends, your existence is richness for me.

Thanks for the patience and the help of my girlfriend \textbf{Emi}, which was ever-loving and supporting during the whole year. 
...
\chapter{User study}
	...
	The control condition has all of the form fields on one page with the description field at the end of the page. We will refer to it as ``index1''.\\
	Because the number of attended cues affects the operator performance, we decided to split the control condition into 3 pages to reduce number of form fields displayed at a time in page, thus minimize visual search and clutter. We define this condition as ``index3''. 
	A second variation with all of the control conditions on one page, however only the description field placement is changed to be in the beginning of the web form, thus aiding episodic memory. We define this condition as ``index2''. 
...
\includepdf[pages={1-3}]{Appendicies/ConsentForm.pdf}
\newpage
\chapter*{Appendix B} \label{App:AppendixB}
\includepdf[pages={1-2}]{Appendicies/InformationSheet.pdf}
\newpage
\chapter*{Appendix C} \label{App:AppendixC}
\includepdf[pages={2-3}]{Appendicies/NASAandSAM.pdf}
\newpage
\chapter*{Appendix D} \label{App:AppendixD}
\includepdf[pages={1-3}]{Appendicies/Comments.pdf}
\newpage
\chapter*{Appendix E} \label{App:AppendixE}
\textbf{Participant information}
\begin{figure}[h]
\centering
\includegraphics[width=1\linewidth]{Appendicies/participant-info}
\end{figure}
\newpage
\chapter*{Appendix F} \label{App:AppendixF}
	\textbf{Mean Hbo data between the conditions}
	\begin{figure}[h]
		\centering
		\includegraphics[width=1\linewidth]{Appendicies/hbo-index}
	\end{figure}
	\\
	\textbf{Mean Hbr data between the conditions}
	\begin{figure}[h]
		\centering
		\includegraphics[width=1\linewidth]{Appendicies/hbr-index}
	\end{figure}	
	\newpage
	\textbf{Mean Hbt data between the conditions}
	\begin{figure}[h]
		\centering
		\includegraphics[width=1\linewidth]{Appendicies/hbt-index}
	\end{figure}	

\newpage
\chapter*{Appendix G} \label{App:AppendixG}
	\textbf{Mean Hbo differences between left and right hemisphere}
	\begin{figure}[h]
		\centering
		\includegraphics[width=1\linewidth]{Appendicies/hbo-valence}
	\end{figure}
	\\
	\textbf{Mean Hbr differences between left and right hemisphere}
	\begin{figure}[h]
		\centering
		\includegraphics[width=1\linewidth]{Appendicies/hbr-valence}
	\end{figure}	
	\newpage
	\textbf{Mean Hbt differences between left and right hemisphere}
	\begin{figure}[h]
		\centering
		\includegraphics[width=1\linewidth]{Appendicies/hbt-valence}
	\end{figure}	
\newpage


\chapter*{Appendix H} \label{App:AppendixH}
\textbf{Mean Hbo statistical tests}
\begin{figure}[h]
\centering
\includegraphics[width=1\linewidth]{Appendicies/stats/hbo-sphreicity-index123}
\end{figure}
\\
\begin{figure}[h]
\centering
\includegraphics[width=1\linewidth]{Appendicies/stats/hbo-anova-index123}
\end{figure}
\newpage
\begin{figure}[h]
\centering
\includegraphics[width=0.7\linewidth]{Appendicies/stats/hbo-descriptive-index123}
\end{figure}
\begin{figure}[h]
\centering
\includegraphics[width=1\linewidth]{Appendicies/stats/hbo-pariwise-index123}
\end{figure}
\newpage
\textbf{Sam subjective arosal}

\begin{figure}[h]
\centering
\includegraphics[width=1\linewidth]{Appendicies/stats/SAM-arousal-sphericity-index123}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=1\linewidth]{Appendicies/stats/SAM-arousal-anova-index123}
\end{figure}
\newpage
\begin{figure}[h]
	\centering
	\includegraphics[width=1\linewidth]{Appendicies/stats/SAM-arousal-pairwise-index123}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.7\linewidth]{Appendicies/stats/SAM-arousal-descriptive-index123}
\end{figure}

\textbf{Sam subjective emotional valence}
\begin{figure}[h]
\centering
\includegraphics[width=0.7\linewidth]{Appendicies/stats/SAM-evalence-descriptive-index123}
\end{figure}
\begin{figure}[h]
\centering
\includegraphics[width=1\linewidth]{Appendicies/stats/SAM-evalence-pairwise-index123}
\end{figure}
\begin{figure}[h]
\centering
\includegraphics[width=1\linewidth]{Appendicies/stats/SAM-evalence-sphericity-index123}
\end{figure}
\newpage

\begin{figure}
\centering
\includegraphics[width=1\linewidth]{Appendicies/stats/SAM-evalence-anova-index123}
\end{figure}

\chapter*{Appendix I} \label{App:AppendixI}
\textbf{Correlation between mental demand from NASA-TLX and time to complete the task}
\begin{figure}[h]
	\centering
	\includegraphics[width=1\linewidth]{Appendicies/stats/mental-demand-vs-time-corr}
\end{figure}
